...
export class Component extends Page {
	constructor() {
		...
		this.items.add(
			p({html: "The Component class is the base of all components. All components extend this class. <br />" +
			...
			comp({cls: "special-css"},
				...
				p({
					cls: "special",
					text: "If you need additional configuration you can also use " +
